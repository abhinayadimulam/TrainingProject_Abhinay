...
public class CustomerService {
	...
	public String sendWelcomeMail(String name, String email) {
		...
		try {
			...
			mimeMessage.setFrom(new InternetAddress("YOUR EMAIL"));
			...
			DataSource fds = new FileDataSource("D://Trainee Engineers March 2019/workspase/TrainingProject_Abhinay/WebContent/images/logo.png");
			mbp1.setDataHandler(new DataHandler(fds));
			mbp1.setHeader("Content-ID", "<image>");
			mp.addBodyPart(mbp1);
			
			mbp1 = new MimeBodyPart();
			fds = new FileDataSource("D://Trainee Engineers March 2019/workspase/TrainingProject_Abhinay/WebContent/images/welcome.png");
			mbp1.setDataHandler(new DataHandler(fds));
