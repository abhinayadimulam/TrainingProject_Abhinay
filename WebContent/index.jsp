		...
		<div class="row row1">
			...
			<div class="col-md-5 header">
				<a href="SignInSignUpForms.jsp"><span
					class="glyphicon glyphicon-log-in"></span>SIGNIN</a> <a
					href="SignInSignUpForms.jsp"><span
					class="glyphicon glyphicon-user"></span>SIGNUP</a> <a href="#"><span
					class="glyphicon glyphicon-user"></span>VENDOR SIGNIN</a> <a href="#"
					class="btn btn-block btn-facebook"><span
					class="fa fa-facebook glif"></span></a> <a href="#"
					class="btn btn-block btn-google-plus"><span
					class="fa fa-google-plus glif"></span></a> <a href="#"
					class="btn btn-block btn-twitter"><span
					class="fa fa-twitter glif"></span></a> <a href="#"
					class="btn btn-block btn-envelope"><span
					class="fa fa-envelope glif"></span></a>
			</div>
		</div>
		<!-- 1 ROW END -->
		<!-- 2 ROW START -->
